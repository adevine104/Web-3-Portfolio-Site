...
burgerAnimationTimeLine.addLabel("burgerToDownArrow")
                        ...
                        .to("#down-left-arrow",{duration:burgerAnimateSpeed, rotation:55, y:0, x:0}, "createArrow")
                        .to("#down-right-arrow",{duration:burgerAnimateSpeed, rotation:-55, y:0, x:0}, "createArrow")
