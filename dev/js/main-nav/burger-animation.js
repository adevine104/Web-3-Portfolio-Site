...
burgerAnimationTimeLine.addLabel("burgerToDownArrow")
                        ...
                        .to("#up-left-arrow",{duration:burgerAnimateSpeed,rotation:45,  alpha:1}, 'createUpArrow')
                        .to("#up-right-arrow",{duration:burgerAnimateSpeed,rotation:-45,  alpha:1}, 'createUpArrow')
