...
burgerAnimationTimeLine.addLabel("burgerToDownArrow")
                        ...
                        .to("#up-left-arrow",{duration:burgerAnimateSpeed,rotation:45, alpha:1, y:-13.5, x:-3}, 'createUpArrow')
                        .to("#up-right-arrow",{duration:burgerAnimateSpeed,rotation:-45, alpha:1, y:-13.5, x:-3}, 'createUpArrow')
